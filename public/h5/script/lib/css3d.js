        ...
        updateM: function () {
            ...
            for (var i in this.__mat) {
                switch (i) {
                    ...
                    case 'up':
                    case 'down':
						console.log('this.__mat[i].bothsides',this.__mat[i].bothsides);
